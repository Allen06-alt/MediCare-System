      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-gray-900 leading-tight">
            What Our Happy <span className="text-blue-600">Patients</span> Say About Us
          </h2>
          <p className="text-gray-500 font-medium">
            We take pride in providing the best healthcare experience for our community.
          </p>
          <button 
            onClick={() => navigate("/appointment")}
            className="bg-gray-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-600 transition-all shadow-xl hover:shadow-blue-200 active:scale-95 flex items-center gap-2"
          >
            Book Appointment
          </button>
        </motion.div>
